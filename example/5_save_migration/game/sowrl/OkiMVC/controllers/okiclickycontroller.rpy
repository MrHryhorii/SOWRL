init python:
    ...
    class OkiClickyController:
        ...
        # cfname:str, label_:str, location:str, x:int, y:int, arts:str=None
        ...
        def get_image(self, obj_arts, dp=True):
            ...
            folder = self.model.store.clicky_folder_path
            default_image = self.model.store.default_clicky_image_path
        ...
        # obj_action:str
        # вернёт str
        def get_action(self, obj_action):
            default_label = self.model.store.default_label

            if renpy.has_label(obj_action):
                return obj_action
            else:
