init python:
    ...
    class OkiPersonController:
        ...
        def add(self, name, surname, cfname, location, x, y, arts=None):
            self.model.add(name, surname, cfname, location, x, y, arts)
        ...
        def get_image(self, obj_arts, dp=True):
            ...
            folder = self.model.store.person_folder_path
            default_image = self.model.store.default_person_image_path
